...
////////////////////////////////////////////////////////////////////////////////
// Initialisation du pong en 3d vue fps en mode 3e personne un peu
////////////////////////////////////////////////////////////////////////////////
...
export class Game {
	...
	update() {
		...
		// Ici a la place de 25 faut verif avec la position de la paddle
		if (this.sphere.position.x <= -25) {
			this.resetBall();
			this.score2++;
		}

		// Pareil qu'au dessus genre
		if (this.sphere.position.x >= 25) {
			this.resetBall();
			this.score1++;
		}
