...
export class Game {
	constructor(numeroShapeRef) {
		...
		this.sphTexture = this.texLoader.load(utils.loadAsset('paddles/cyberSphere.png'));
		this.sphTexture.minFilter = THREE.LinearFilter;

		this.padTexture = this.texLoader.load(utils.loadAsset('paddles/cyberPaddle.png'));
		...
		// TODO: Use pad texture instead (map: this.padTexture);
